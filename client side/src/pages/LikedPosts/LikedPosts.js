        ...
        <Grid item xs={6.5}>
            <Box style={{display: 'flex' , flexDirection: 'column' , marginLeft: '50px' , marginRight: '50px'}}>
                <Grid container style={{display: 'flex', marginTop: '30px'  }} >
                    <Grid item xs={10}>
                        <Typography style={{fontWeight: 700, fontSize: '28px'}}>Liked Posts</Typography>
                    </Grid>
                    <Grid item xs={2}>
                          <Typography style={{fontWeight: 700, fontSize: '22px'}}>({myPosts?.likedPosts?.length})</Typography>
                    </Grid>
                </Grid>
                ...
                <Box style={{display: 'flex',  flexDirection: 'column' }}>
                      ...
                      {
                        myPosts?.likedPosts?.length > 0 && (
                          Object.values(myPosts?.likedPosts).map((item) => (
