        ...
        <>
            <Grid container className={classes.root}>
                ...
                <Grid item xs={6}>
                    ...
                    <Typography variant="h5" style={{fontWeight: 700 , marginLeft: '150px' , marginBottom: '10px'  }} >Sign In Form</Typography>
                    {
                        msg && (
                        ...
                        <Button variant="contained" size="medium" style={{maxWidth: '150px' , marginLeft: '150px' , marginTop: '45px'}} onClick={signIn} >Sign In </Button>

                        <Button style={{color:'#fff' , fontWeight: 600, fontSize: '17px' , backgroundColor: '#1B1464' , marginTop: '65px'}} component={Link} to='/signup' > Don't have an Account?  Sign Up Now</Button>
                    </Box>
                </Grid>
            </Grid>
        </>
